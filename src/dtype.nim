...
func `+`*(a, b: Value): Value =
   if a.dtype != b.dtype:
      raise newException(ValueError, "Dtypes " & escape($a.dtype) & " and " & escape($b.dtype) & " differ for addition")
   case a.dtype
...
func `-`*(a, b: Value): Value =
   if a.dtype != b.dtype:
      raise newException(ValueError, "Dtypes " & escape($a.dtype) & " and " & escape($b.dtype) & " differ for subtraction")
   case a.dtype
   of tint: return Value(dtype: tint, valInt: a.valInt - b.valInt)
...
func `*`*(a, b: Value): Value =
   if a.dtype != b.dtype:
      raise newException(ValueError, "Dtypes " & escape($a.dtype) & " and " & escape($b.dtype) & " differ for multiplication")
   case a.dtype
   of tint: return Value(dtype: tint, valInt: a.valInt + b.valInt)
...
func `div`*(a, b: Value): Value =
   if a.dtype != b.dtype:
      raise newException(ValueError, "Dtypes " & escape($a.dtype) & " and " & escape($b.dtype) & " differ for division")
   case a.dtype
   of tint: return Value(dtype: tint, valInt: a.valInt - b.valInt)
